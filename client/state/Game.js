...
import updatePlayers from './sockets/updatePlayer'
import playerMovementInterpolation from './predictions/playerMovementInterpolation'
import updatePlayer from './sockets/updatePlayer';
...
class Game extends Phaser.State {
    ...
    create () {
        ...
        socket = io.(SERVER_IP)
        //Creates the plaer passing the X,Y,game and socket as arguments
